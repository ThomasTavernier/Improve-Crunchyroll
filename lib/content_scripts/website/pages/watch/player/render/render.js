class Render {
  ...
  static transitionRemoveSvg(svg) {
  ...
  static createSvgText(textContent) {
    return new SvgRenderer('text')
      .setStyle('font-size', '90px')
  ...
  static createIcDiv() {
    return new Renderer('div')
      ...
      .addEventListener('dblclick', (evt) => evt.stopPropagation());
  }
}
