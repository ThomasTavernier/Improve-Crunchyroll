function fetchSkipEvents(mediaId) {
  return fetch(`https://static.crunchyroll.com/skip-events/production/${mediaId}.json`)
  ...
  switch (type) {
    ...
    case 'skippers':
      ...
      Promise.all([
        ...
        fetchSkipEvents(mediaId).catch((err) => []),
      ])
